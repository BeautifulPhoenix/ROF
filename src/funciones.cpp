...
do
{
        ...
        cout<<"====================================================="<<endl;
        std::cout << "1. Iniciar Juego con el Panel Personalizado" << std::endl;
		std::cout << "2. Iniciar Juego con el Panel por Defecto" << std::endl;
		std::cout << "0. Salir " << std::endl;
        cout<<"====================================================="<<endl;
    ...
    do
{
    ...
    std::cout << concursante.nom <<" Bienvenido a la Ruleta de la Suerte Personalizada" <<std::endl;

    cout << "La Pista Es: " <<endl;
    std::cout << " "<< pistap << std::endl;
